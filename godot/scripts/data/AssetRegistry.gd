...
const UNITS := {
        "zane": {
                ...
                "display_name": "Zane",
                "role": "Swordsman",
                "idle": "res://assets/sprites/units/zane.png",
                "action": "res://assets/sprites/units/zane.png",
                "portrait": "res://assets/sprites/units/zane.png",
        ...
        "mira": {
                ...
                "display_name": "Mira",
                "role": "Mage",
                "idle": "res://assets/sprites/units/mira.png",
                "action": "res://assets/sprites/units/mira.png",
                "portrait": "res://assets/sprites/units/mira.png",
                "prompt_source": "docs/prompts/characters-player-units.md",
        },
        "kael": {
                "id": "kael",
                "display_name": "Kael",
                "role": "Guardian",
                "idle": "res://assets/sprites/units/kael.png",
                "action": "res://assets/sprites/units/kael.png",
                "portrait": "res://assets/sprites/units/kael.png",
                "prompt_source": "docs/prompts/characters-player-units.md",
        },
        "lyra": {
                "id": "lyra",
                "display_name": "Lyra",
                "role": "Archer",
                "idle": "res://assets/sprites/units/lyra.png",
                "action": "res://assets/sprites/units/lyra.png",
                "portrait": "res://assets/sprites/units/lyra.png",
                "prompt_source": "docs/prompts/characters-player-units.md",
        },
}
...
const ENEMIES := {
        "null_drake": {
                ...
                "idle": "res://assets/sprites/units/null_drake.png",
                "attack": "res://assets/sprites/units/null_drake.png",
                "prompt_source": "docs/prompts/characters-enemies.md",
        },
        "storm_imp": {
                "id": "storm-imp",
                "display_name": "Storm Imp",
                "idle": "res://assets/sprites/units/storm_imp.png",
                "attack": "res://assets/sprites/units/storm_imp.png",
                "prompt_source": "docs/prompts/characters-enemies.md",
        },
        "fen_wraith": {
                "id": "fen-wraith",
        ...
        "void_cultist": {
                ...
                "idle": "res://assets/sprites/units/void_cultist.png",
                "attack": "res://assets/sprites/units/void_cultist.png",
                "prompt_source": "docs/prompts/characters-enemies.md",
        },
}
