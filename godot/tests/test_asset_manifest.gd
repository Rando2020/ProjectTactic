...
func _initialize() -> void:
	...
	for unit_id in ["zane", "mira", "kael", "lyra", "void_cultist", "null_drake", "storm_imp"]:
	...
	_expect_eq(str(character_entries.get("lyra", {}).get("art_id", "")), "character-wayfarer", "Lyra maps to Wayfarer")
	...
	_expect_eq(str(character_entries.get("storm_imp", {}).get("art_id", "")), "enemy-hollow-stray", "Storm Imp maps to Hollow Stray")
